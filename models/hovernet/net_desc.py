            ...
            u3 = nn.Sequential(
                OrderedDict(
                    [
                        (
                            "conva",
                            nn.Conv2d(1024, 256, 5, stride=1, padding=0, bias=False),
                        ),
            ...
            u2 = nn.Sequential(
                OrderedDict(
                    [
                        (
                            "conva",
                            nn.Conv2d(512, 128, 5, stride=1, padding=0, bias=False),
                        ),
            ...
            u1 = nn.Sequential(
                OrderedDict(
                    [
                        ...
                        (
                            "conva",
                            nn.Conv2d(256, 64, 5, stride=1, padding=0, bias=False),
                        ),
                    ]
                )
            )
...
def create_model(mode=None, **kwargs):
    if mode == "original":
        ...
        from .net_desc_fast import HoVerNet as HoVerNetFast
        return HoVerNetFast(**kwargs)
    else:
